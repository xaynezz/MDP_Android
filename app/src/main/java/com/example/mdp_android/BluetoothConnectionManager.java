...
//                        });
    ...
    private class ConnectedThread extends Thread{
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            // Use the static methods from MainActivity to update the UI
            ((BluetoothPage) mContext).runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    MainActivity.getBluetoothStatus().setText("Connected");
                    MainActivity.getBluetoothStatus().setTextColor(Color.parseColor("#006400")); // Dark green
                    MainActivity.getConnectedDevice().setText(mmDevice.getName());
                }
            });
